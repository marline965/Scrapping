...
(async () => {
  try {
    ...
    await Promise.all([
      await page.click('button[class="_54k8 _52jh _56bs _56b_ _28lf _9cow _56bw _56bu"]'),
          ...
          class Post {
            constructor(document) {
              ...
              this.postdata = this.postContainer.querySelector(
                'article[class="_55wo _5rgr _5gh8 _3drq async_like"]> div[class="story_body_container"] > div[class="_5rgt _5nk5 _5wnf _5msi"]'
              ).innerText; //getting post text
              
              this.postLikes = this.postContainer.querySelector(
                'footer._22rc > div > div > a > div > div > div._1g06'
              ).innerText;
